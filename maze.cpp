 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(35,160," SAI VIDYA INSTITUTE OF TECHNOLOGY");
	glColor3f(1,1,1);
	...
	output(40,50,"");
	glColor3f(1,0,0);
	output(60,50,"Prof. Sukruth Gowda M A");
	glColor3f(1,0,0);
	output(70,40,"(Assistant Professor,Dept. of CSE)");
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(1,0,0);
	output(60,30,"Prof. Chithra Apoorva D A");
...
void idle()
{
  if(df==1)
  {
	...
	if((count<80) && ((px>=0 && px<=4) && (py>=162 && py<=168)))
	{
		df=5;
	}
  }
...
int main(int argc,char **argv)
{
  ...
  glutAddMenuEntry("Instruction",1);
